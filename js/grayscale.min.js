...
function collapseNavbar() {
    $(".navbar").offset().top > 50 ? $(".navbar-fixed-top").addClass(
        ...
        "top-nav-collapse")
    $(".navbar").offset().top > 50 ? $("#top_logo").fadeIn():$("#top_logo").hide()
}
...
$(window).scroll(collapseNavbar), $(document).ready(collapseNavbar), $(function() {
    ...
    "dropdown-toggle active" != $(this).attr("class") &&
        "dropdown-toggle" != $(this).attr("class") && $(
            ".navbar-toggle:visible").click()
});
var map = null;
google.maps.event.addDomListener(window, "load", init), google.maps.event.addDomListener(
